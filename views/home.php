            ...
            <?php foreach ($platforms as $platform): ?>
                <div class="card rounded-3xl shadow-2xl overflow-hidden flex flex-col group">
                    ...
                    <div class="p-8 flex-grow">
                        <a href="/product/<?php echo $platform['id']; ?>">
                            <h3 class="text-2xl font-bold mb-4 group-hover:text-blue-500 transition"><?php echo htmlspecialchars($platform['title']); ?></h3>
                        </a>
                        <p class="text-sm opacity-80 leading-relaxed mb-6 line-clamp-3"><?php echo nl2br(htmlspecialchars($platform['description'])); ?></p>
                    </div>

                    <div class="p-8 pt-0 mt-auto space-y-4">
                        <a href="/product/<?php echo $platform['id']; ?>" class="block w-full text-center bg-gray-800 text-white font-bold py-3 rounded-xl hover:bg-gray-900 transition flex items-center justify-center">
