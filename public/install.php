            ...
            <?php if($all_met): ?>
                <form method="POST" class="space-y-6">
                    ...
                    <div class="pt-6 border-t border-slate-100">
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label class="block text-slate-700 text-xs font-bold uppercase ml-1 tracking-widest">Email</label>
                                <input type="email" name="admin_email" value="admin@example.com" required class="w-full px-5 py-3 rounded-2xl border border-slate-200 focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 outline-none transition shadow-sm">
                            </div>
                            <div class="space-y-2">
